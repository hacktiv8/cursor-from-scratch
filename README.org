...
- Computational thinking: penjelasan mendetil dari apa yang mau kita buat. Bisa direpresentasikan sebagai fitur-fitur utama yang mau dikembangkan. Dipisah menjadi slices, milestone, user stories, tiket, dll.
- Procedural thinking: Bagaimana membuatnya agar terwujud. Dengan cara memberikan informasi sedetil mungkin. Contoh: batasan project. Fitur apa yang dipilih untuk dikembangkan, mana yang belum perlu dikembangkan dan fitur mana yang "dibuang".
...
Script akan dieksekusi di trigger point yang diinginkan seperti beforeSubmitPrompt, beforeShellCommand, dll.
...
#+CAPTION: Contoh eksekusi hoooks
#+NAME:   fig:Hooks
[[./hooks.png]]
** Customization Marketplace
Cursor juga menyediakan marketplace untuk kustomisasi yang merupakan gabungan dari rules, skills, subagents dan hooks. Kita bisa menggunakan hasil kustomisasi buatan teman-teman komunitas.

Contoh menarik: Continual Learning, Superpower atau Compound Engineering.

#+CAPTION: Contoh Customization Marketplace
