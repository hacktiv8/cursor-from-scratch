...
2. Pick a lens from the **Lens Roster** below and put it in `Engagement critic`.
...
THIS RUN'S LENS: Engagement critic   (see REVIEW-PROMPT.md "Lens Roster" for the exact
