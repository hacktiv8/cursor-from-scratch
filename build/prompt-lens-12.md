...
2. Pick a lens from the **Lens Roster** below and put it in `Consistency / formatting`.
...
THIS RUN'S LENS: Consistency / formatting   (see REVIEW-PROMPT.md "Lens Roster" for the exact
...
- Lens run: Consistency / formatting
