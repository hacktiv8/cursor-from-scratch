...
2. Pick a lens from the **Lens Roster** below and put it in `Cold indexer`.
...
THIS RUN'S LENS: Cold indexer   (see REVIEW-PROMPT.md "Lens Roster" for the exact
