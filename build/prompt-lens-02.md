...
2. Pick a lens from the **Lens Roster** below and put it in `Expert reader / fact-checker`.
...
THIS RUN'S LENS: Expert reader / fact-checker   (see REVIEW-PROMPT.md "Lens Roster" for the exact
...
- Lens run: Expert reader / fact-checker
