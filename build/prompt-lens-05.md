...
2. Pick a lens from the **Lens Roster** below and put it in `Beginner reader`.
...
THIS RUN'S LENS: Beginner reader   (see REVIEW-PROMPT.md "Lens Roster" for the exact
