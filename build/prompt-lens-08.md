...
2. Pick a lens from the **Lens Roster** below and put it in `Assumptions pass`.
...
THIS RUN'S LENS: Assumptions pass   (see REVIEW-PROMPT.md "Lens Roster" for the exact
